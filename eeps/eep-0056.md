    ...
    Created: 04-Mar-2021
    Erlang-Version: 25
    Post-History: 08-Mar-2021, 17-Mar-2021, 23-Mar-2021
    Replaces:
****
...
Although the propoesed changes are backwards compatible, applications using
...
Taking care of this issue is at the discretion of implementors if he expects
