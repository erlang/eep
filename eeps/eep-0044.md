...
As an hypothetical example, assuming that OTP_RELEASE had been
...
number string will be split at each ".".  If a component consists of
of numbers only, it will be converted to an integer; otherwise, it
will kept as a string.  For example, if the version of the `compiler`
