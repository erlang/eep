...
and `-moduledoc`.  This EEP also includes an extra section on additional
features that can help writing documentation with those attributes more
productive, but that's optional. As with EEP 48, this proposal pertains
exclusively to API references and their documentation.  It doesn't cover
guides, tutorials, and other documentation formats.
