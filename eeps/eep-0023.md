EEP: 23
Title: Allow variables in fun M:F/A
Version: $Revision$
Last-Modified: $Date$
...
Reference Implementation
    ...
    (a) accept fun M:F/A where M, F, and A are constants or
        variables,
    (b) generate the same abstract syntax term that was
	generated in the past when they are all constants,
    (c) pretend that erlang:make_fun(M, F, A) had been written
